            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" class="form-control form-control-sm @error('name') is-invalid @enderror" placeholder="Enter Full Name">
                        @error('name')
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select name="roles" class="form-control form-control-sm @error('roles') is-invalid @enderror">
                ...
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <select name="companies" class="form-control form-control-sm @error('companies') is-invalid @enderror">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="password" name="password" class="form-control form-control-sm @error('password') is-invalid @enderror" placeholder="Enter Password">
                        @error('password')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="password" name="password_confirmation" class="form-control form-control-sm" placeholder="Enter Confirmation Password">
                    </div>
                </div>
            </div>
...
<div class="login mt-2 text-center">
    <p class="mb-0">Already have an account? Login <a href="{{ route('login') }}">here</a></p>
</div>
