      ...
      <div class="card-body">
        ...
        <form action="{{ route('clients.store') }}" method="POST">
          ...
          <div class="form-group">
            ...
            <input type="text" name="client_code" class="form-control" id="client_code" placeholder="Enter client code" required>
          </div>
          <div class="form-group">
            <label for="client_name">Client Name</label>
            <input type="text" name="client_name" class="form-control" id="client_name" placeholder="Enter company name" required>
          </div>
