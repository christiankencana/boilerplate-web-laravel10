      ...
      <div class="card-body">
        ...
        <form action="{{ route('companies.store') }}" method="POST">
          ...
          <div class="form-group">
            ...
            <input type="text" name="company_code" class="form-control" id="company_code" value="{{ old('company_code', $recommended_code) }}" required>
          </div>
          <div class="form-group">
            <label for="company_main_name">Company Name</label>
            <input type="text" name="company_main_name" class="form-control" id="company_main_name" placeholder="Enter company name" required>
          </div>
          <div class="form-group">
            <label for="company_alternative_name">Company Alternative Name</label>
            <input type="text" name="company_alternative_name" class="form-control" id="company_alternative_name" placeholder="Optional - Enter alternative name (max 4 letters)" maxlength="4">
          </div>
