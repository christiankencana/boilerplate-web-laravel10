        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form
                        action="{{ route('companies.locations.update', ['company' => $company->id, 'location' => $location->id]) }}"
                        method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="location_name" class="form-control" id="location_name"
                                        value="{{ $location->location_name }}" placeholder="Enter Location Name" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="location_address" class="form-control" id="location_address"
                                        value="{{ $location->location_address }}" placeholder="Enter Location Address"
                                        required>
                                </div>
                            </div>
                        </div>
                        <button type="submit" class="btn btn-primary">Update Location</button>
                        <a href="{{ route('companies.locations.index', $location->company_id) }}"
