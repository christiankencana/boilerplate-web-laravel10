          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <div>
                  <label class="mr-2">
                    <input type="radio" name="status_account" value="active" {{ $user->status_account == 'active' ? 'checked' : '' }} required> Active
                  </label>
                  <label>
                    <input type="radio" name="status_account" value="inactive" {{ $user->status_account == 'inactive' ? 'checked' : '' }} required> Inactive
                  </label>
                </div>
              </div>
            </div>
